...
\usepackage{geometry}
\geometry{lmargin=1.1in, rmargin=1.1in, tmargin=1in, bmargin=1in}
\usepackage{babel}
\usepackage{xcolor}
	\definecolor{navy}{rgb}{0.1,0.2,0.4}
\usepackage[unicode, colorlinks=true, urlcolor=navy, linkcolor=navy]{hyperref}
\usepackage{fontspec}
\setmainfont{AvenirLTStd-Medium}
\usepackage{parskip}
...
\begin{small}
	...
	~~$\|$~~
		\href{tel:15039848009}{+1 503 984 8009}
	~~$\|$~~
